 ...
 */
public class AtmTableStatCriticalMessageDto extends Application {

    private TableView<StatCriticalMessageDto> table = new TableView();
    private ObservableList<StatCriticalMessageDto> data;
    private String nameLabel;

    public AtmTableStatCriticalMessageDto(List<StatCriticalMessageDto> dtoList, String nameLabel) {
